...
<div class="x_panel">
    ...
    <div class="x_content">
      <br>
      <form id="demo-form2" enctype="multipart/form-data" method="post" action="{{route('product.store')}}" class="form-horizontal form-label-left">
@csrf
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="" name='name' id="first-name" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="Number" value="" name="price" id="first-name" required="" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
