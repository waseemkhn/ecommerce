          ...
          <ul class="nav side-menu">
            ...
            <li class=""><a><i class="fa fa-home"></i> Category Manager <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu" style="display: none;">
                <li class="current-page"><a href="{{route('category.index')}}">List</a></li>
            ...
            <li class=""><a><i class="fa fa-home"></i> Product Booking  <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu" style="display: none;">
                <li class="current-page"><a href="{{route('admin.bookinglist')}}">List</a></li>
              </ul>
            </li>
          </ul>
        </div>
