...
<div class="span9">
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="{{asset('upload/'.$product->image)}}" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			...
			<div class="span6">
				  ...
				  <div class="control-group">
					...
					<div class="controls">
						<form method="post" action="{{route('cart.store')}}">
							@csrf
					<input required='required' type="number" name="qty" class="span1" placeholder="Qty."/>
					<input type="hidden" value="{{$product->id}}" name="product_id"/>
					@if (Auth::user())
					<button type="submit" class="btn btn-large btn-primary pull-right"> Add to cart <i class=" icon-shopping-cart"></i></button>
					@else
					<button class=" btn-large btn-primary pull-right"><a href="{{route('user_login')}}"> Add to cart <i class=" icon-shopping-cart"></i></a></button>
				...
				<hr class="soft"/>
				<h4>{{@$product->productdetail->total_items}} in stock</h4>
				...
				<hr class="soft clr"/>
				<p>
					{{@$product->productdetail->descriptions}}
				</p>
				...
				<ul class="thumbnails">
					...
					<li class="span3">
					  <div class="thumbnail">
						...
						<div class="caption">
						  <h5>{{$item->productdetail->title}}</h5>
						  <p> 
